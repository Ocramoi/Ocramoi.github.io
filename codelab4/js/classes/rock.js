...
class Rock extends Entity {
	...
	*/
	constructor (
		...
		let ra = Math.random();
		if(ra < 1/3)
			this.rootElement.style.backgroundImage = "url('assets/cup.png')";
		else if(ra < 2/3)
			this.rootElement.style.backgroundImage = "url('assets/bag.png')";
		else
			this.rootElement.style.backgroundImage = "url('assets/apple.png')";
