const MAX_GOLD_SIZE = 75;
const MIN_GOLD_SIZE = 30;
...
class Gold extends Entity {
	...
	*/
	constructor (
		...
		{
			this.imgDir = '';
			this.rootElement.style.backgroundImage = "url('assets/bass.png')";
		}
		else
		{
			this.imgDir = '1';
			this.rootElement.style.backgroundImage = "url('assets/bass1.png')";
		}
