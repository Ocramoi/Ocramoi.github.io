let menuPont = document.getElementById("pontuacao");
pontuacao = 0;
...
class Map {
	...
	*/
	verifyForCollision (entity1, entity2) {
		...
		if (entity1 instanceof Player && (entity2 instanceof Bullet || entity2 instanceof BulletSmall || entity2 instanceof BulletBig)) return;
		if (entity1 instanceof Bullet && entity2 instanceof Player) return;
		
		if (MovableEntity.didEntitiesColide(entity1, entity2)) {
			if((entity1 instanceof Asteroid || entity1 instanceof StarDestroyer || entity1 instanceof Tiefighter) && entity2 instanceof Bullet) menuPont.innerText = `Pontuação: ${pontuacao += entity1.collided(entity2, pontuacao)}`;
			else entity1.collided(entity2);

			if(entity1 instanceof Bullet && (entity1 instanceof Asteroid || entity1 instanceof StarDestroyer || entity1 instanceof Tiefighter)) menuPont.innerText = `Pontuação: ${pontuacao += entity2.collided(entity1, pontuacao)}`;
			else entity2.collided(entity1);
		}
	}
